...
import os
import json
from src.scripts import summarize_experiments

class TestSummarizeExperiments(unittest.TestCase):
    def setUp(self):
    ...
    def test_summarize_runs(self):
        summarize_experiments.main()
        self.assertTrue(os.path.exists("data/clean/experiments.json"))
